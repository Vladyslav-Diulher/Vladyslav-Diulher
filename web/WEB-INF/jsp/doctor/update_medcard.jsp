                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <form action="controller" method="post">
                            <input type="hidden" name="command" value="vipiska"/>
                            <input type="hidden" name="medicalCardId" value=${medicalCard.id}/>
                            <input class="btn btn-light" type="submit" value="<fmt:message key="vipiska"/>">
                        </form>
                    </c:otherwise>
                </c:choose>
            </div>
        ...
        <div class="col-sm-6" style="padding-left: 0">
            <div class="main">
                <form id="login_form" action="controller" method="post">
                    <input type="hidden" name="command" value="updateMedCard"/>

                    <label for="diagnose"><fmt:message key="diagnose"/>:</label>
                    ...
                    <label for="operation"><fmt:message key="operation"/>:</label>
